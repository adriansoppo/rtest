...
var post = JSON.parse(mountNode.getAttribute('data-post'));
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement("textarea", { style: { width: '100%', height: '300px' }, type: "text", value: this.state.value, onChange: this.handleChange }),
          _react2.default.createElement("input", { className: "button button-primary button-large", type: "submit", value: "Save " })
        )
      );
    }
  }]);
...
_reactDom2.default.render(_react2.default.createElement(HelloMessage, null), mountNode);
